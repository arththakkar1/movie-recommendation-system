...
The `mrs` project is designed to ensure scalability, maintainability, and clear separation of concerns. Below is a detailed overview of the folder structure:
